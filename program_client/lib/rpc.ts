 ...
 * 2. `[writable]` gem: {@link GemMetadata} 
 */
export const freeze = (args: FreezeArgs): TransactionInstruction => {
    const data = serialize(
        {
            struct: {
                id: "u8",
 ...
 * 2. `[writable]` gem: {@link GemMetadata} 
 */
export const freezeSendAndConfirm = async (
    args: Omit<FreezeArgs, "feePayer"> & { 
